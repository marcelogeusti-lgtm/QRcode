...
import { getFirestore, doc, setDoc, getDoc, updateDoc, deleteDoc, collection, query, where, getDocs, increment } from "https://www.gstatic.com/firebasejs/10.9.0/firebase-firestore.js";
...
export { 
  db, doc, setDoc, getDoc, updateDoc, deleteDoc, collection, query, where, getDocs, increment,
